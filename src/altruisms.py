...
from wallawin.src.data_representation import share_or_take_plot, plot_env, save_simulation_settings
...
SETTINGS = TakeOrShareSettings(steps=100, pop_size=10, abundance=1, rep_factor=100, simulation_name="test_3",
                               base_longevity=2,
